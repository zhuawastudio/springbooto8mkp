<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学业成绩" prop="xueyechengji">
          <el-input v-model="ruleForm.xueyechengji" 
              placeholder="学业成绩" clearable  :readonly="ro.xueyechengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学业成绩" prop="xueyechengji">
              <el-input v-model="ruleForm.xueyechengji" 
                placeholder="学业成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="德育成绩" prop="deyuchengji">
          <el-input v-model="ruleForm.deyuchengji" 
              placeholder="德育成绩" clearable  :readonly="ro.deyuchengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="德育成绩" prop="deyuchengji">
              <el-input v-model="ruleForm.deyuchengji" 
                placeholder="德育成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体育素质" prop="tiyusuzhi">
          <el-input v-model="ruleForm.tiyusuzhi" 
              placeholder="体育素质" clearable  :readonly="ro.tiyusuzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体育素质" prop="tiyusuzhi">
              <el-input v-model="ruleForm.tiyusuzhi" 
                placeholder="体育素质" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="智育素质" prop="zhiyusuzhi">
          <el-input v-model="ruleForm.zhiyusuzhi" 
              placeholder="智育素质" clearable  :readonly="ro.zhiyusuzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="智育素质" prop="zhiyusuzhi">
              <el-input v-model="ruleForm.zhiyusuzhi" 
                placeholder="智育素质" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="总分" prop="zongfen">
            <el-input v-model="zongfen"
                placeholder="总分" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zongfen" label="总分" prop="zongfen">
              <el-input v-model="ruleForm.zongfen" 
                placeholder="总分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    zongfen: {
      get: function () {
        return 0+parseFloat(this.ruleForm.xueyechengji==""?0:this.ruleForm.xueyechengji)+parseFloat(this.ruleForm.deyuchengji==""?0:this.ruleForm.deyuchengji)+parseFloat(this.ruleForm.tiyusuzhi==""?0:this.ruleForm.tiyusuzhi)+parseFloat(this.ruleForm.zhiyusuzhi==""?0:this.ruleForm.zhiyusuzhi) || 0
      }
    },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
          ...
          if(o=='xueyechengji'){
            this.ruleForm.xueyechengji = obj[o];
	    this.ro.xueyechengji = true;
            continue;
          }
          if(o=='deyuchengji'){
            this.ruleForm.deyuchengji = obj[o];
	    this.ro.deyuchengji = true;
            continue;
          }
          if(o=='tiyusuzhi'){
            this.ruleForm.tiyusuzhi = obj[o];
	    this.ro.tiyusuzhi = true;
            continue;
          }
          if(o=='zhiyusuzhi'){
            this.ruleForm.zhiyusuzhi = obj[o];
	    this.ro.zhiyusuzhi = true;
            continue;
          }
          if(o=='zongfen'){
            this.ruleForm.zongfen = obj[o];
	    this.ro.zongfen = true;
            continue;
          }
          if(o=='xuenian'){
    ...
    // 提交
    onSubmit() {
        this.ruleForm.zongfen = this.zongfen
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zonghechengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zonghechengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
